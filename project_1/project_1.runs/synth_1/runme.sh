...
HD_PWD='C:/CSE490/16bitProcessor/cse490/cse490/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log datapath_impl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source datapath_impl.tcl
